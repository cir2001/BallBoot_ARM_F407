...
//IO方向设置
#define I2C_SDA_IN()  {GPIOB->MODER&=~(3<<(11*2));GPIOB->MODER|=0<<11*2;}	//PB11输入模式
#define I2C_SDA_OUT() {GPIOB->MODER&=~(3<<(11*2));GPIOB->MODER|=1<<11*2;} //PB11输出模式

//IO操作函数	 
#define I2C_SCL    PBout(10) 		//SCL
#define I2C_SDA    PBout(11) 		//SDA	 
#define I2C_READ_SDA   PBin(11) 		//输入SDA 
...
u8 I2C_Read_Byte(unsigned char ack);	//IIC读一个字节，ack=1时，发送ACK，ack=0，发送nACK
