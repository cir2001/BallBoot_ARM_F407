...
//MPU6050 AD0控制脚
//#define MPU_AD0_CTRL			PCout(7)	//控制AD0电平,从而控制MPU地址
...
#define MPU_ADDR							0x68	//MPU6050/MPU6500 IIC地址
#define MPU_ADDR_ID						0x70	//MPU6500 器件地址

////因为模块AD0默认接GND,所以转为读写地址后,为0XD1和0XD0(如果接VCC,则为0XD3和0XD2)  
//#define MPU_READ    0XD1
//#define MPU_WRITE   0XD0

u8 MPU6500_Init(void); 								//初始化MPU6050
u8 MPU6500_Write_Len(u8 addr,u8 reg,u8 len,u8 *buf);//IIC连续写
u8 MPU6500_Read_Len(u8 addr,u8 reg,u8 len,u8 *buf); //IIC连续读 
u8 MPU6500_Write_Byte(u8 reg,u8 data);				//IIC写一个字节
u8 MPU6500_Read_Byte(u8 reg);						//IIC读一个字节

u8 MPU6500_Set_Gyro_Fsr(u8 fsr);
u8 MPU6500_Set_Accel_Fsr(u8 fsr);
u8 MPU6500_Set_LPF(u16 lpf);
u8 MPU6500_Set_Rate(u16 rate);
u8 MPU6500_Set_Fifo(u8 sens);
